...
SECRET_KEY = 'django-insecure-xc!vq-9)q$%pg9bt_+)+ib3z656syxb@)f@o%l1#+d_*j(y@ol'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Updated for templates folder
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # Use Path object for cleaner syntax
]

# Media files (for handling user-uploaded files, like student photos)
